...
export async function validateAnswerAction(data: unknown) {
  try {
...
¿Es correcta en esencia?`,
    ...
    console.error("[validateAnswerAction]", err)
    return { correct: false, feedback: "No se pudo revisar la respuesta. Inténtalo de nuevo." }
  }
}
